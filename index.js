...
const token = "7190417149:AAGP-p7uO6ZHgdL8VbXXwAZOPGWi8EGhJlE";
const admin = "5325612831";
const DATABASE_URL = "https://telegrambot-d58c1-default-rtdb.firebaseio.com"; 
const WEBHOOK_URL = "image-generator-bot-kappa.vercel.app";
  ...
  if (!exists) {
    ...
    try {
      ...
      const caption =
        ...
        msg.text +
        "`\n\n*🧑‍💻 Created By:* [BOTNAME](https://telegram.dog/GrowFollowSMHBot)";
      const keyboard = {
        reply_markup: {
          inline_keyboard: [
            [{ text: "🧑‍💻 Developer", url: "https://telegram.dog/SocialMediaHikeOfficial" }]
          ]
        },
        parse_mode: "Markdown",
        reply_to_message_id: msg.message_id
